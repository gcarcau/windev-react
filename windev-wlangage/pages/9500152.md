---
title: "Colonnes de type Combo dans les champs Table (syntaxe préfixée)"
...
- par programmation avec la fonction [<Liste>.Ajoute](1000017319.md), par exemple dans l'événement "Initialisation" du champ Table.
...
Pour sélectionner un élément de la colonne de type Combo, il suffit de spécifier l'indice de l'élément de la combo à afficher. Cet indice peut être utilisé avec les [fonctions de gestion des champs Table](1000024319.md).
Par exemple :

- ajout d'une ligne avec la fonction [<Table>.Ajoute](1000023600.md) :
  ```wlangage
  ...
  ```
- modification de la 5° ligne avec la fonction [<Table>.ModifieLigne](1000024275.md) :
  ```wlangage
  // TABLE_TableClient contient :
  // - une colonne de type Combo affichant la civilité des clients
  // (1 correspond à "Mr", 2 à "Mme" et 3 à "Melle")
