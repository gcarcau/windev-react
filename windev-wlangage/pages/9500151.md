---
title: "Image avec défilement automatique (WEBDEV) (syntaxe préfixée)"
...
3. Dans l'onglet "UI", dans la zone "Défilement automatique", cochez l'option "Faire défiler les images d'un répertoire ou d'une liste programmée" puis indiquez les différentes options concernant le défilement :
  ...
  - **Démarrer automatiquement**. Si cette option n'est pas sélectionnée, il est possible de démarrer le défilement grâce à la fonction [<Image>.LanceDéfilement](1000023749.md).
