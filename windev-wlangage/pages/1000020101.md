---
title: "TableauChercheParProcédure (Fonction)"
english: "ArraySeekByProcedure"
type: "Fonction"
id: "1000020101"
module: "WDLang1"
...
Remarque : Cette fonction est équivalente à la fonction [ChercheParProcédure](1000020102.md).
...
>
>
> | *tcDichotomique* | Recherche dichotomique décroissante.  Ce mode de recherche est rapide mais il doit être utilisé sur un tableau trié par ordre croissant avec la même procédure de comparaison ou une procédure équivalente (voir fonction [TableauTrie](3075007.md)). |
> | --- | --- |
