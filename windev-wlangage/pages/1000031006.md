---
title: "Manipuler un champ Tableau de bord par programmation (syntaxe préfixée)"
...
Pour manipuler un champ Tableau de bord par programmation, WINDEV, WEBDEV et WINDEV Mobile proposent les [fonctions de gestion des Tableaux de bord](1000022537.md).
...
- la fonction [<Tableau de bord>.AjouteWidget](1000022502.md) pour définir le Widget à ajouter.
- la fonction [<Tableau de bord>.ConfigurationInitiale](1000022525.md) pour paramétrer la position du Widget dans la configuration initiale.
...
- Rafraîchir le Widget avec la fonction [<Tableau de bord>.Affiche](1000022500.md).
