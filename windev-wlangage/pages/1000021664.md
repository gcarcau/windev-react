...
### Sites multilingues
La fonction **<Page>.Utilise** peut être utilisée dans le cas de sites multilingues. En effet, cette fonction permet de ré-ouvrir une page en prenant en compte la langue spécifiée par la fonction [Nation](3054014.md).
...
Remarque : Si la fonction **<Page>.Utilise** est utilisée dans le code d'un champ Bouton, la page sera ouverte dans la destination définie pour ce champ Bouton (onglet "Général" de la description du champ ou fonction [ChangeDestination](3058005.md)).
...
- Pour ré-afficher une page, il est conseillé d'utiliser la fonction [<Page>.Actualise](1000021659.md).
- Pour afficher une page sans fermer les contextes ouverts sur le serveur, il est conseillé d'utiliser la fonction [<Page>.Affiche](1000021661.md).
