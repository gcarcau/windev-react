...
Pour réaliser directement les manipulations de cette leçon, nous allons travailler dans le projet "WLangage" (créé dans la leçon précédente (consultez le paragraphe [Un projet pour découvrir le WLangage](1410087570.md) de la leçon 1).
...
1. Lancez le test du projet en mode simulateur :
  ...
  - Cliquez sur [image: Tester le projet] pour lancer le test du projet en mode simulateur.
...
2. Le volet "Trace du débogueur" contient nos exemples de concaténation :
  ```wlangage
  Concaténation : Mon outil de développement, c'est WINDEV Mobile !Saisie directe : Mon outil de développement, c'est WINDEV Mobile !
  ```
...
4. Le volet "Trace du débogueur" contient les informations suivantes :
  ```wlangage
  mon outil de developpement, c'est windev mobile !MONOUTILDEDÉVELOPPEMENT,C'ESTWINDEVMOBILE!
  ```
...
| [Leçon précédente](1410087570.md) | [Sommaire](1410087586.md) | [Leçon suivante](1410087589.md) |
| --- | --- | --- |
