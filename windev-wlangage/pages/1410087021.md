---
title: "Evénements associés à un champ Traitement de texte"
id: "1410087021"
module: "WDControls"
...
| A chaque changement de la sélection | Exécuté lors de la modification de la sélection dans le champ Traitement de texte. |
| Rafraîchissement du ruban | Exécuté lorsque le ruban doit être mis à jour (par exemple pour afficher les caractéristiques du texte sélectionné). |
| Après chargement d'un document | Exécuté après le chargement d'un document dans le champ Traitement de texte. |
| Avant fermeture du document | Exécuté avant la fermeture d'un document dans le champ Traitement de texte. |
| A chaque modification | Exécuté à chaque modification du champ Traitement de texte. |
