---
title: "SourceVersPage (Fonction)"
english: "SourceToPage"
type: "Fonction"
id: "1000017405"
module: "WDLang4"
...
- La fonction **SourceVersPage** n'effectue aucune lecture du fichier de données. C'est la valeur de l'enregistrement chargé en mémoire qui est utilisée pour initialiser les champs. Il faut donc qu'un enregistrement soit au préalable chargé en mémoire (fonctions [HLit](3044047.md), [HLitRecherche](3044050.md), [HLitPremier](3044051.md), ...).
...
- La fonction **SourceVersPage** affecte les champs Image reliés à des rubriques de type mémo image.
