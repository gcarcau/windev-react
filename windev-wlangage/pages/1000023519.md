---
title: "<Zone répétée>.ModifieFI (Fonction)"
english: "<Looper>.ModifyIW"
type: "Fonction"
id: "1000023519"
module: "WDLang2"
...
```wlangage
soit N = ZR_Composant.AjouteFI(FI_PROCESSEUR, "i7", 2)
ZR_Composant.ModifieFI(N, FI_DISQUE, "SAMDATA", "SSD", 20 000 000)
```

## Syntaxe

```wlangage
<Résultat> = <Champ Zone répétée>.ModifieFI(<Indice> , <Fenêtre interne> [, <Paramètre 1> [... [, <Paramètre N>]]])
```
