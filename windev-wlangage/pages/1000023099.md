---
title: "Gestion de MQTT (syntaxe préfixée)"
...
2. Connectez-vous au broker (fonction [<Variable mqttSession>.Connecte](1000023084.md)).
3. Vous pouvez :
  - Publier un message (fonction [<Variable mqttSession>.Publie](1000023091.md)). Dans ce cas, il est nécessaire de définir :
    - le sujet,
  ...
  - Vous abonner à un message (fonction [<Variable mqttSession>.Abonne](1000023083.md)).
  - Vous désabonner (fonctions [<Variable mqttSession>.Désabonne](1000023086.md), [<Variable mqttSession>.DésabonneTout](1000023090.md))
4. Déconnectez-vous (fonction [<Variable mqttSession>.Déconnecte](1000023085.md)).
...
- [<Variable mqttSession>.Publie (Fonction)](1000023091.md)
