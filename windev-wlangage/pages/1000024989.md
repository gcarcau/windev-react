---
title: "<Source>.HistoriqueModification (Fonction)"
english: "<Source>.HistoryModification"
type: "Fonction"
id: "1000024989"
module: "WDLang4"
...
sModification = sHistorique.ExtraitChaîne(rangPremier, RC)
TANTQUE sModification <> EOT
	...
	SELON sEtat
		CAS "D"
			LISTE_ListeModification.Ajoute(ChaîneConstruit(...
	...
	FIN
   	sModification = sHistorique.ExtraitChaîne(rangSuivant, RC)
FIN
```
...
```wlangage
<Résultat> = <Source>.HistoriqueModification(<Rubrique de recherche> , <Valeur recherchée> , <Liste des rubriques> [, <Nombre de modifications> [, <Séparateur de valeurs> [, <Séparateur des modifications>]]])
```
...
```wlangage
<Résultat> = <Source>.HistoriqueModification(<Numéro de l'enregistrement> , <Liste des rubriques> [, <Nombre de modifications> [, <Séparateur de valeurs> [, <Séparateur des modifications>]]])
```
