---
title: "Gestion des agendas Google"
id: "1000017561"
module: "WDLang5"
...
4. Validez la création de l'agenda grâce à la fonction [GglEcrit](1000017401.md).
...
2. Utilisez la fonction [GglListeAgenda](1000017330.md). Cette fonction permet de lister les agendas disponibles. Les agendas trouvés sont affectés au tableau de variables de type gglAgenda.
3. Utilisez la fonction [GglRemplitAgenda](1000017337.md) pour récupérer les événements. Il est possible de récupérer les événements d'un seul ou de plusieurs agendas. Il est possible de filtrer les événements à récupérer (par exemple entre deux dates).
...
2. Utilisez la fonction [GglRécupèreAgenda](1000017410.md). Cette fonction permet de récupérer l'agenda Google (et ses événements) correspondant au titre spécifié.
...
4. Utilisez la fonction [GglEcrit](1000017401.md) pour mettre à jour l'agenda sur le serveur.
...
**Remarque** : Il est possible d'effectuer plusieurs modifications avant d'utiliser la fonction [GglEcrit](1000017401.md).
...
**Remarque** : Il est possible d'effectuer plusieurs suppressions avant d'utiliser la fonction [GglEcrit](1000017401.md).
**Exemple** :
