---
title: "<Variable Document>.Insère (Fonction)"
english: "<Document variable>.Insert"
type: "Fonction"
id: "1000024513"
module: "WDLang1"
...
Insère un objet dans une variable de type [Document](1000022461.md). Les objets manipulables sont :
...
// Insère une image à la position spécifiée
...
MonDocument.Insère(nPositionInsertion, elt)
```
...
```wlangage
<Résultat> = <Document>.Insère(<Position> , <Elément à insérer>)
```
...
> Nom d'une variable de type [Document](1000022461.md) à manipuler.
`<Position>` *Entier*
> Position à laquelle l'élément doit être inséré. Cette position est exprimée en nombre de caractères.
`<Elément à insérer>` *Type correspondant à l'élément à insérer*
> Elément à insérer :
>
