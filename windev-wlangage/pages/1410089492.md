---
title: "<Zone répétée>.ModifiePI (Fonction)"
english: "<Looper>.ModifyIP"
type: "Fonction"
id: "1410089492"
module: "WDLang2"
...
```wlangage
soit N = ZR_Composant.AjoutePI(PI_PROCESSEUR, "i7", 2)
ZR_Composant.ModifiePI(N, PI_DISQUE, "SAMDATA", "SSD", 20 000 000)
```

## Syntaxe

```wlangage
<Résultat> = <Champ Zone répétée>.ModifiePI(<Indice> , <Page interne> [, <Paramètre 1> [... [, <Paramètre N>]]])
```
...
- Astuce : Pour connaître le numéro de la répétition utilisée (cas par exemple d'un clic sur un bouton de la page interne), créez un attribut dans le champ Zone répétée et affectez-le avec le résultat de la fonction **<Zone répétée>.ModifiePI**.
