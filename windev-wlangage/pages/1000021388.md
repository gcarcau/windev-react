---
title: "<Fenêtre>.DepuisSource (Fonction)"
english: "<Window>.FromSource"
type: "Fonction"
id: "1000021388"
module: "WDLang4"
...
- Cette fonction est également disponible pour les pages WEBDEV. Elle est équivalente à la fonction [<Page>.DepuisSource](1000021393.md).
...
- La fonction **<Fenêtre>.DepuisSource** gère la valeur NULL. Si le contenu de la rubrique correspond à NULL, une chaîne vide sera affichée dans le champ de saisie associé. Pour modifier ce mode d'affichage, utilisez la fonction [ChampErreur](3025036.md).
