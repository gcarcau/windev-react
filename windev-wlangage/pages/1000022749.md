---
title: "<Variable Connexion>.RécupèreLog (Fonction)"
english: "<Connection variable>.RetrieveLog"
type: "Fonction"
id: "1000022749"
module: "WDLang4"
...
SI MaConnexion.RécupèreLog("20180101", "20183112", "C:\Mes Documents\MesLogs.txt") = Faux ALORS
...
```wlangage
<Résultat> = <Connexion>.RécupèreLog(<Date de début> , <Date de fin> , <Fichier Log destination> [, <Jauge>])
```
...
> Nom de la variable de type [Connexion](1514073.md) décrivant la connexion vers le serveur depuis lequel les logs doivent être récupérés.
