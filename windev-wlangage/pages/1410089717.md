---
title: "<Variable adminWBAuth>.SupprimeCompte (Fonction)"
english: "<WBAdminAuth variable>.DeleteAccount"
type: "Fonction"
id: "1410089717"
module: "WDLang2"
...
Résultat_Supp est un booléen = wbAuthLogin.SupprimeCompte(compteWB)
```

## Syntaxe

```wlangage
<Résultat> = <Serveur d'application WEBDEV>.SupprimeCompte(<Compte>)
```
