---
title: "<Variable Polygone2D>.Croise (Fonction)"
english: "<Polygon2D variable>.Cross"
type: "Fonction"
id: "1410090527"
module: "WDLang4"
...
# <Variable Polygone2D>.Croise (Fonction)
...
Permet de savoir si un polygone en 2 dimensions croise une autre géométrie.
...
oPolyligne.AjoutePoint(0.00, 2.00)
oPolyligne.AjoutePoint(-2.00, -2.00)
// Corrige la géométrie créée
oPolyligne = oPolyligne.Corrige()

// On a bien un croisement entre la polyligne et le premier polygone
Trace(oPolyligne.Croise(oPolygone2D_1))
```
...
- la fonction **<Variable Polygone2D>.Croise** renvoie Faux.
- une erreur non fatale est levée lorsque la fonction **<Variable Polygone2D>.Croise** est appelée avec deux polygones.
...
Il est possible d'effectuer un parcours sur un fichier de données avec un filtre concernant des données spatiales. Par exemple, le filtre utilisé peut être basé sur le résultat de la fonction **<Variable Polygone2D>.Croise**.
...
- Fonction_WLangage correspond à la fonction **<Variable Polygone2D>.Croise**.
