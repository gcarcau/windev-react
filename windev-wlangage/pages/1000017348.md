...
- Cette fonction est identique à la fonction [TableauAjoute](3075003.md).
...
> _(WINDEV, WEBDEV - Code Serveur, Linux, Android, iPhone/iPad, Widget IOS, Mac Catalyst, Java, Ajax)_ // Exemple d'ajout d'un élément dans un fichier XML
