---
title: "gValeurMémorisée (Fonction)"
english: "gStoredValue"
type: "Fonction"
id: "1410088363"
module: "WDLang1"
...
- Cette fonction est identique à la fonction [gLien](3029043.md).
...
La fonction **gValeurMémorisée** peut être appelée à n'importe quelle place dans la ligne à ajouter.
Par exemple :
...
### Valeur ajoutée
Lorsqu'une valeur est ajoutée par la fonction **gValeurMémorisée**, cette valeur n'est prise en compte ni dans le tri, ni pour les lettres d'appel.
...
La fonction [ListeCherche](3049003.md) tient compte des valeurs ajoutées par la fonction **gValeurMémorisée**.

### Sensibilité à la casse
La fonction **gValeurMémorisée** n'est pas sensible à la casse (minuscules/majuscules).
...
La fonction **gValeurMémorisée** est utilisée pour gérer les champs de type "Combo auto-alimentée".
...
### Champ Planning
Si les ressources du planning ont été créées avec la fonction [PlanningAjouteRessource](1000019279.md) en utilisant la fonction **gValeurMémorisée**, le nom de la ressource obtenue par exemple avec la propriété [RessourceSélectionnée](1000019445.md) correspondra à la valeur précisée dans la fonction **gValeurMémorisée** pour cette ressource.
Exemple :
...
Si la fonction **gValeurMémorisée** doit retourner une chaîne vide (""), le résultat obtenu est différent si le champ utilisé est un champ Combo ou une colone de type Combo dans une champ Table.
...
Pour conserver le même code de récupération de la valeur de **gValeurMémorisée** pour un champ Combo et une colonne Combo, il est conseillé d'utiliser un champ Combo placé dans une [colonne de type conteneur](1013263.md) du champ Table.

**Composante : wd300obj.dll**

## Voir Aussi

- [gValeurMémoriséeActive (Fonction)](1410088364.md)
