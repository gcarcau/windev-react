---
title: "Evénements associés aux champs Jauge"
id: "1013178"
module: "WDControls"
...
> _(WINDEV, WINDEV Mobile)_ WINDEV et WINDEV Mobile gèrent par défaut l'événement suivant :EvénementCondition d'exécutionInitialisationExécuté à l'ouverture de la fenêtre. *(*) Par défaut, l'événement "Initialisation" de chaque champ est exécuté selon l'ordre de création des différents champs dans la fenêtre. Pour modifier cet ordre d'exécution : Sous le volet "Fenêtre", dans le groupe "Ordre", cliquez sur "Initialisation".Dans la fenêtre qui s'affiche, utilisez les flèches situées sur la droite pour modifier l'ordre d'initialisation des champs.

> _(WEBDEV - Code Serveur, WEBDEV - Code Navigateur, PHP)_ WEBDEV gère par défaut l'événement suivant :EvénementCondition d'exécutionInitialisation (code serveur)Exécuté à l'ouverture de la page.
