...
- Cette fonction est équivalente à la fonction [TableauInsère](3075009.md).
...
> Si <Indice d'insertion> est égal au nombre d'éléments du tableau +1, l'élément est ajouté à la fin du tableau (équivalent à la fonction [TableauAjoute](3075003.md) ou à la fonction [Ajoute](1000017348.md)).
...
`<Indice d'insertion>` *Entier*
> Indice du tableau où l'élément doit être inséré. Tous les éléments à partir de cet indice seront décalés de 1 élément.
> Si <Indice d'insertion> est égal au nombre d'éléments du tableau +1, l'élément est ajouté à la fin du tableau (équivalent à la fonction [TableauAjoute](3075003.md)).
> Si <Indice d'insertion> est supérieur au nombre d'éléments du tableau +1, une erreur WLangage est générée.
...
- Pour ajouter un élément à la fin d'un tableau à une dimension, utilisez la fonction [TableauAjoute](3075003.md) ou la fonction [Ajoute](1000017348.md).
