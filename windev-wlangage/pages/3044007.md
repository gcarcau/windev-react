...
Importe un fichier XML dans un fichier de données au format HFSQL Classic ou Client/Serveur (fichier de données décrit sous l'éditeur d'analyses ou déclaré par les fonctions [HDéclare](3044203.md), [HDéclareExterne](3044204.md) ou [HDécritFichier](3044206.md)).
...
Ce format est également utilisé par la fonction [HExporteXML](3044069.md).
