---
title: "<Variable Connexion>.GèreMiseAJourServeur (Fonction)"
english: "<Connection variable>.ManageServerUpdate"
type: "Fonction"
id: "1000022662"
module: "WDLang4"
...
Ces droits correspondent respectivement aux constantes *hDroitGestionServeur* et *hDroitArrêtServeur* utilisées dans les fonctions [<Variable Connexion>.InfoDroitServeur](1000022668.md) et [<Variable Connexion>.ModifieDroitServeur](1000022710.md).
...
```wlangage
(<Ancienne planification>, <Ancienne URL>) = <Connexion>.GèreMiseAJourServeur([<Planification> [, <URL>]])
```
