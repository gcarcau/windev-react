---
title: "Champ Caméra : décoder les codes-barres (syntaxe préfixée)"
...
- Vrai (valeur par défaut), le décodage du code-barres s'arrête.
  La fonction [CaméraDémarreDécodage](1000022454.md) (ou la fonction [<Caméra>.DémarreDécodage](1000022475.md)) permet de relancer la lecture.
...
- Décodage et prise de photos :
  - Si le champ Caméra est en mode "Compatible 26" : La prise de photos et l'enregistrement de vidéos sont interdits si la détection de codes-barres est activée (la fonction [<Caméra>.Capture](1000022382.md) renvoie une erreur dans ce cas).
  - Si le champ Caméra est en mode 27 :
    ...
    - Il n'est pas possible d'enregistrer une vidéo pendant que le décodage de code-barres est actif.
      - Si le décodage est actif lors de l'appel de la fonction [<Caméra>.VidéoDémarre](1410088106.md), il sera arrêté et automatiquement relancé à la fin de l'enregistrement.
...
- Lorsque le champ Caméra est configuré pour autoriser le décodage de code-barres (dans la fenêtre de description), le décodage démarre automatiquement à l'ouverture de la fenêtre.
  Pour empêcher ce comportement, il est possible d'appeler la fonction [CaméraArrêteDécodage](1000022449.md) (ou la fonction [<Caméra>.ArrêteDécodage](1000022474.md)) dans l'événement "Initialisation" du champ Caméra. Le décodage des codes-barres pourra être relancé grâce à la fonction [CaméraDémarreDécodage](1000022454.md) (ou la fonction [<Caméra>.DémarreDécodage](1000022475.md)).
