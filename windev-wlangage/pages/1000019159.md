---
title: "<Variable zipArchive>.AjouteListeFichier (Fonction)"
english: "<zipArchive variable>.AddFileList"
type: "Fonction"
id: "1000019159"
module: "WDLang3"
...
Ajoute et compresse automatiquement une liste de fichiers (de n'importe quel type) dans une archive au format ZIP, CAB, WDZ, 7z, TAR, gzip ou TGZ (TAR.GZ). Cette fonction est plus rapide que la fonction [<Variable zipArchive>.AjouteFichier](1000019050.md) exécutée pour chaque fichier.
Nouveauté 2025
...
> Nom d'une variable de type [zipArchive](1000018679.md) correspondant à l'archive dans laquelle les fichiers doivent être ajoutés.
...
>
>
> Si un chemin à mémoriser est précisé, l'ajout du fichier sera équivalent à l'appel de la fonction <Variable zipArchive>.AjouteFichier suivi d'un appel à la fonction <Variable zipArchive>.ChangeChemin.
...
> - au nom d'une procédure WLangage. Pour plus de détails sur cette procédure, consultez [Paramètres de la procédure utilisée par la fonction <Variable zipArchive>.AjouteListeFichier](1000025731.md).
>
>
