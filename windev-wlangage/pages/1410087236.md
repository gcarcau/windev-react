...
Nous allons créer une procédure globale dans la collection de procédures du projet WLangage. Cette collection de procédures sera une collection de procédures serveur. **A retenir**
...
1. Dans le volet "Code" du ruban, dans le groupe "Procédures", déroulez "Nouveau" et sélectionnez "Nouvelle procédure globale (Serveur)".
  [image: Création d'une procédure globale]
...
| [Leçon précédente](1410087233.md) | [Sommaire](1410087510.md) | [Leçon suivante](1410087237.md) |
| --- | --- | --- |
