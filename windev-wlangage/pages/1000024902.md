---
title: "<Chaîne ANSI>.Découpe (Fonction)"
english: "<ANSI string>.Split"
type: "Fonction"
id: "1000024902"
module: "WDLang1"
...
(sPays1, sPays2, sPays3, sPays4) = sPays.Découpe(", ")
...
// Utilisation de l'affectation multiple
(sEntrée, sPlat, sDessert) = sMenu.Découpe(" ", ", ")
// sEntrée vaut "Entrée",
...
```wlangage
<Résultat> = <Chaîne initiale>.Découpe([<Séparateur> [, <Options>]])
```
...
```wlangage
<Résultat> = <Chaîne initiale>.Découpe(<Séparateur 1> , <Séparateur 2> ... [, <Séparateur N>] [, <Options>])
```
