...
Crée une vue HFSQL à partir de deux vues précédemment créées (fonction [HCréeVue](3044159.md)). Un grand nombre d'opérations ensemblistes peut être réalisé lors de la fusion des vues.
...
> | *hVueDifférée* | La vue est créée, mais sera exécutée en différé avec la fonction [HExécuteVue](3044079.md). |
...
> _(WINDEV, WEBDEV - Code Serveur, Hyper File 5.5)_ Hyper File 5.5Pour manipuler une base de données au format Hyper File 5 avec la fonction HFusionneVue, vous devez réaliser la fusion avec la fonction HCréeVue_55.
...
- [<Source>.FusionneVue (Fonction)](1000024983.md)
