...
> _(WINDEV, WEBDEV - Code Serveur, Etats et Requêtes, Code Utilisateur (MCU), PHP, Ajax)_ // Conversion d'Euros en Livres Irlandaises avec gestion de l'écart d'arrondi
...
ResConversion vaut 34,94 et Écart vaut 0,01.Pour retrouver le montant initial, utilisez la ligne de code suivante :
