---
title: "eNomDevise (Fonction)"
english: "eCurrencyName"
type: "Fonction"
id: "3033006"
module: "WDLang1"
...
**Remarque** : Le libellé d'une devise est affiché dans les champs de type "Monétaire + Euro" si le masque de saisie le permet (le signe $ est indiqué).

## Exemple

```wlangage
// Récupération du libellé du franc
ResLibellé = eNomDevise(eFRF)
```

## Syntaxe

```wlangage
<Résultat> = eNomDevise(<Devise>)
```

`<Résultat>` *Chaîne de caractères*
> Libellé de la devise spécifiée.
`<Devise>` *Entier ou constante*
> Identifiant de la devise ou constante associée à la devise (voir Notes).
