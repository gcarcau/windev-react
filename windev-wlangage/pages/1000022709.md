---
title: "<Variable Connexion>.ModifieDroitFichier (Fonction)"
english: "<Connection variable>.ModifyFileRights"
type: "Fonction"
id: "1000022709"
module: "WDLang4"
...
**Remarque** : Il est possible de connaître les droits d'un groupe ou d'un utilisateur sur un fichier de données HFSQL Client/Serveur grâce à la fonction [<Variable Connexion>.InfoDroitFichier](1000022667.md).
...
sDroits = MaConnexion.InfoDroitFichier("Dupont", hDroitLecture + hDroitAjout, "MaBase", "MonFichier.fic")
...
```wlangage
<Résultat> = <Connexion>.ModifieDroitFichier(<Utilisateur/Groupe> , <Droits à modifier> , <Nouvelles valeurs> , <Base de données> , <Fichier de données>)
```
...
La modification du droit est effective dès que la fonction **<Variable Connexion>.ModifieDroitFichier** est exécutée pour les utilisateurs connectés et concernés par la modification. Il n'est pas nécessaire de redémarrer le serveur pour prendre en compte les nouveaux droits.
