---
title: "<Chaîne ANSI>.FinitPar (Fonction)"
english: "<ANSI string>.EndsWith"
type: "Fonction"
id: "1000024903"
module: "WDLang1"
...
Chaîne2 = "Procédure"
SI Chaîne1.FinitPar(Chaîne2, ccSansCasse) <> 9 ALORS
...
```wlangage
<Résultat> = <Chaîne initiale>.FinitPar(<Chaîne recherchée> [, <Options de recherche>])
```
...
```wlangage
<Résultat> = <Chaîne initiale>.FinitPar(<Chaînes recherchées> [, <Options de recherche>])
```
...
### Fonction <Chaîne ANSI>.FinitPar et Unicode
