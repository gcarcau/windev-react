---
title: "Manipuler un champ Bandeau défilant par programmation (syntaxe préfixée)"
...
Pour manipuler un champ Bandeau défilant par programmation, WEBDEV propose les [Fonctions de gestion du champ Bandeau défilant](1000022632.md).
...
- soit d'utiliser la fonction WLangage [<Bandeau défilant>.LanceDéfilement](1000022631.md).
...
Pour arrêter le défilement automatique, utilisez la fonction [<Bandeau défilant>.ArrêteDéfilement](1000022628.md).
