---
title: "<Fenetre interne>.ChangeFenêtreSource (Fonction)"
english: "<Internal window>.ChangeSourceWindow"
type: "Fonction"
id: "1000020950"
module: "WDLang1"
...
> _(Android, iPhone/iPad, Widget IOS, Mac Catalyst)_ Cas des défilements de fenêtres internes : La fonction <Fenetre interne>.ChangeFenêtreSource permet de modifier la fenêtre actuellement affichée. Cette modification est enregistrée dans la liste des fenêtres internes à faire défiler.
...
Lors de l'utilisation de la fonction **<Fenetre interne>.ChangeFenêtreSource**, les événements suivants sont exécutés :
