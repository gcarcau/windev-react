---
title: "<Table>.ModifieColonne (Fonction)"
english: "<Table>.ModifyColumn"
type: "Fonction"
id: "1000024274"
module: "WDLang1"
...
Si la saisie en cascade n'est pas activée, le fichier de données lié au champ Table fichier n'est pas modifié. Pour écrire l'enregistrement dans le fichier de données, exécutez la fonction [<Table>.Enregistre](1000024249.md) après la fonction **<Table>.ModifieColonne**.
...
- modifier directement l'enregistrement dans le fichier avec la fonction [<Source>.Modifie](1000025038.md),
- utiliser la fonction [<Table>.Affiche](1000023505.md) pour ré-actualiser le champ Table.

### Fonction <Table>.ModifieColonne et propriété Modifié
La fonction **<Table>.ModifieColonne** n'a aucune influence sur la propriété [Modifié](2510080.md). La propriété [Modifié](2510080.md) permet de savoir si la colonne en cours a été modifiée directement par l'utilisateur (saisie directe dans le champ Table).
...
- [TableModifieColonne (Fonction)](1000017179.md)
