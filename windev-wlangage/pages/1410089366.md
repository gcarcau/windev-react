---
title: "ZoneRépétéeAjoutePI (Fonction)"
english: "LooperAddIP"
type: "Fonction"
id: "1410089366"
module: "WDLang2"
...
```wlangage
ZoneRépétéeAjoutePI(ZR_Composant, PI_PROCESSEUR, "i7", 2)
ZoneRépétéeAjoutePI(ZR_Composant, PI_DISQUE, "SAMDATA", "SSD", 20 000 000)
```
...
- Astuce : Pour connaître le numéro de la répétition utilisée (cas par exemple d'un clic sur un bouton de la page interne), créez un attribut dans le champ Zone répétée et affectez-le avec le résultat de la fonction **ZoneRépétéeAjoutePI**.
