---
title: "<Source>.ExécuteRequêteAsynchrone (Fonction)"
english: "<Source>.ExecuteQueryAsynchronous"
type: "Fonction"
id: "1000026111"
module: "WDLang4"
...
```wlangage
REQ_MaRequete.ExécuteRequêteAsynchrone(hRequêteDéfaut, MaProcedurePourChaqueEnregistrement, MaProcedureFinale)
...
```wlangage
<Nom de la requête>.<Nom du paramètre 1> = xxx<Nom de la requête>.<Nom du paramètre 2> = xxx<Nom de la requête>.<Nom du paramètre 3> = xxx<Nom de la requête>.ExécuteRequêteAsynchrone(<Procédure>)SI ErreurDétectée = Vrai ALORS ...
```
