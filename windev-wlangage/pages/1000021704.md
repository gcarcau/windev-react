...
```wlangage
<Résultat> = <Champ Onglet>.Ouvre(<Libellé> , <Fenêtre interne> [, <Paramètre 1> [... [, <Paramètre N>]]])
```
...
- Il est possible de modifier la fenêtre interne utilisée dans le volet avec la fonction [<Fenetre interne>.ChangeFenêtreSource](1000020950.md). Par exemple :
  ```wlangage
