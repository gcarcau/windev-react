---
title: "<Tableur>.Sauve (Fonction)"
english: "<Spreadsheet>.Save"
type: "Fonction"
id: "1000023734"
module: "WDLang1"
...
- Pour ouvrir le fichier ".xlsx" sauvé avec une autre application, il est nécessaire de le fermer avec la fonction [<Tableur>.Ferme](1000023722.md).
- Le fichier sauvé pourra être rechargé dans un champ Tableur grâce aux fonctions [<Tableur>.Charge](1000023719.md) et [xlsOuvre](3080017.md).
- Cette fonction est utilisable uniquement sur un champ Tableur présent dans une fenêtre.
- La fonction **<Tableur>.Sauve** met à jour la propriété [CheminFichier](1000023104.md) du champ Tableur en associant le nom du fichier chargé au champ Tableur.
