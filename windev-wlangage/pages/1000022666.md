---
title: "<Variable Connexion>.InfoDroitBaseDeDonnées (Fonction)"
english: "<Connection variable>.InfoDatabaseRights"
type: "Fonction"
id: "1000022666"
module: "WDLang4"
...
LesDroits = MaConnexion.InfoDroitBaseDeDonnées("Dupont", hDroitLecture + hDroitAjout, "MaBase")
...
> | *hDroitInterditAccèsBaseDeDonnées* | Droit d'interdire l'accès à une base de données (fonctions [<Variable Connexion>.InterditAccèsBaseDeDonnées](1000022690.md) et [<Variable Connexion>.FinInterditAccèsBaseDeDonnées](1000022661.md)). |
...
Pour modifier les droits sur une base de données pour un utilisateur ou un groupe d'utilisateurs, utilisez la fonction [<Variable Connexion>.ModifieDroitBaseDeDonnées](1000022707.md).
